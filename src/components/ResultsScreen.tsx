      ...
      <div className="min-h-screen p-4">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card className="bg-gray-900/80 border-gray-700 backdrop-blur-sm p-6">
            <h3 className="text-white text-xl font-bold mb-6">Detailed Breakdown</h3>
            <div className="grid gap-4">
              <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg">
                <span className="text-gray-300">Sentiment vs. expression alignment</span>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg">
                <span className="text-gray-300">Response confidence (filler words, tone)</span>
                <div className="flex items-center space-x-2">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <Card className="bg-gray-900/80 border-gray-700 backdrop-blur-sm p-6 text-center">
              <h4 className="text-white text-lg font-semibold mb-4">Share Results</h4>
              <div className="space-y-4">
                <p className="text-gray-300">
                  Download or share your authenticity badge
                </p>
